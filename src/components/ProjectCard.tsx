    ...
    return (
        <>
            <div
                ...
                <a className={"text-indigo-700 dark:text-cyan-200 underline block"} href={props.project.link}
                   target="_blank">Link
                    to the github page</a>
                <a className={"text-indigo-700 dark:text-cyan-200 underline block"}
                   href={`/projects/${props.project.slug}`} target="_blank">Link
                    to the details page</a>
