...
export default function AngularIcon(props: Props) {
    return (
        <>
            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width={props.size}
                 height={props.size}><title>Angular</title>
                <path
                    fill="#DD0031"
