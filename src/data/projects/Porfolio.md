...
description: "A portfolio website built with Astro and TypeScript"
created_at: "2026-01-06"
link: https://github.com/Yannick-Vk/Portfolio
slug: portfolio-project
tags: [ "Astro", "React", "TypeScript", "Frontend" ]
---
...
The project uses Astro's server-side rendering capabilities to ensure fast load times and optimal performance.
The project uses Markdown files to manage project content,
making it easy to add or update projects without modifying the core codebase.
